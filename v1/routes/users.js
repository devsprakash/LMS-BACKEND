...
const { Register , talk_to_expert , post_your_story, post_blog,  Booking, HiringRequirements, course_enroll, login, contact_us, forgot_password, reset_password, verify_email, refer_and_Earn, arrange_call_back, apply_now, brochure_download, verify_otp, brochure_verify_otp } = require('../controllers/user.controller')
