...
const { user_validator, login_validator , apply_now_validator , resend_otp_validator , otp_validator , brochure_download_validator, call_back_validator , verify_email_validator , reset_password_validator, forgot_password_validator , contact_us_validator , talk_to_expert_validator, enroll_form_validator, hiring_validator, booking_validator , post_blog_validation, post_story_validation, ValidatorResult, refer_and_earn_validator } = require('../../validation/user.validator')
const { Register , talk_to_expert , post_your_story, post_blog,  Booking, HiringRequirements, course_enroll, login, contact_us, forgot_password, reset_password, verify_email, refer_and_Earn, arrange_call_back, apply_now, brochure_download, verify_otp, brochure_verify_otp, resend_otp, brchure_resend_otp } = require('../controllers/user.controller')
